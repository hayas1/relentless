...
use relentless::interface::{
    command::{Assault, Relentless, WorkerKind},
    report::console::{CaseConsoleReport, RelentlessConsoleReport},
};

use relentless_http::command::HttpAssault;
use relentless_http_dev_server::route::{self, counter::CounterResponse};
...
async fn test_repeat_config() {
    ...
    let report = assault.assault_with(configs, service.clone()).await.unwrap();

    let mut buf = Vec::new();
    assault.report_with(&report, &mut buf).unwrap();
...
async fn test_validate_config() {
    let assault = HttpAssault::<Body, Body>::new(Relentless {
        file: vec!["tests/config/feature/validate.yaml".into()],
        no_color: true,
        ..Default::default()
    });
    let (configs, _) = assault.configs();
...
#[tokio::test]
async fn test_allow_override_config() {
    let assault = HttpAssault::<Body, Body>::new(Relentless {
        file: vec!["tests/config/feature/allow_override.yaml".into()],
        no_color: true,
        ..Default::default()
    });
    let (configs, _) = assault.configs();
...
async fn test_json_diff_config() {
    let assault = HttpAssault::<Body, Body>::new(Relentless {
        file: vec!["tests/config/feature/json_diff.yaml".into()],
        no_color: true,
        ..Default::default()
    });
    let (configs, _) = assault.configs();
...
async fn test_headers_config() {
    let assault = HttpAssault::<Body, Body>::new(Relentless {
        file: vec!["tests/config/feature/headers.yaml".into()],
        no_color: true,
        ..Default::default()
    });
    let (configs, _) = assault.configs();
...
async fn test_body_config() {
    let assault = HttpAssault::<Body, Body>::new(Relentless {
        file: vec!["tests/config/feature/body.yaml".into()],
        no_color: true,
        ..Default::default()
    });
    let (configs, _) = assault.configs();
...
async fn test_timeout_config() {
    let assault = HttpAssault::<Body, Body>::new(Relentless {
        file: vec!["tests/config/feature/timeout.yaml".into()],
        no_color: true,
        ..Default::default()
    });
    let (configs, _) = assault.configs();
...
async fn test_template_config() {
    let assault = HttpAssault::<Body, Body>::new(Relentless {
        file: vec!["tests/config/feature/template.yaml".into()],
        no_color: true,
        ..Default::default()
    });
    let (configs, _) = assault.configs();
...
async fn test_async_config() {
    let assault = HttpAssault::<Body, Body>::new(Relentless {
        file: vec!["tests/config/feature/async.yaml".into(); 5],
        no_color: true,
        ..Default::default()
    });
    let (configs, _) = assault.configs();
